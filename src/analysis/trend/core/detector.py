...
class TrendDetector:
    ...
    def detect_support_resistance_levels(self, df: pd.DataFrame, 
        ...
        return calculate_support_resistance_levels(df, window=window, min_touches=min_touches)
    ...
    def calculate_trend_strength_score(self, df: pd.DataFrame) -> pd.Series:
        ...
        """
        # Usar utilidad consolidada que ya implementa un método robusto
        return calculate_trend_strength(df, method='combined')
